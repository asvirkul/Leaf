...
<body>
    ...
    <header class="main">
        <nav class="header-content">
            ...
            <div class="logo">
                <p id="logo"><a href="<?php echo PATH ?>"><img id="logo-pic" src="<?= PATH . VIEW ?>images/razor.png" alt="razor logo"><i class="line-logo"></i><i>LEAF</i></a></p>
            </div>
            <div class="menu-right">
                <ul class="menu">
                    <li><a href="#">Account</a></li>
                    <li><a class="bag-header" href="#">Bag (0)</a></li>
                </ul>
            </div>
